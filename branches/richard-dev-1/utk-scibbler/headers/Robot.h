...
class Robot {
	 ...
	 * tranlation velocity, rotational velocity, and possibly 
	...
	/**
	 * Definites a default behavior for issuing speeds to the left
	...
	/**
	 * A default function for telling the robot to move foward
