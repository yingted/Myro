                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                      (if (eq? (car temp_1) '<cont-57>)
                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                          (if (eq? (car temp_1) '<cont-58>)
                                                                                                                                                                                                                                              (let ((proc 'undefined)
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                (set! handler (list-ref temp_1 3))
                                                                                                                                                                                                                                                (set! env (list-ref temp_1 2))
                                                                                                                                                                                                                                                (set! proc (list-ref temp_1 1))
                                                                                                                                                                                                                                                (set! k2_reg k)
                                                                                                                                                                                                                                                (set! handler_reg handler)
                                                                                                                                                                                                                                                (set! env2_reg env)
                                                                                                                                                                                                                                                (set! args_reg value_reg)
                                                                                                                                                                                                                                                (set! proc_reg proc)
                                                                                                                                                                                                                                                (set! pc apply-proc))
                                                                                                                                                                                                                                              (if (eq? (car temp_1) '<cont-59>)
                                                                                                                                                                                                                                                  (let ((operands 'undefined)
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    (set! handler (list-ref temp_1 3))
                                                                                                                                                                                                                                                    (set! env (list-ref temp_1 2))
                                                                                                                                                                                                                                                    (set! operands (list-ref temp_1 1))
                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                  (if (eq? (car temp_1) '<cont-84>)
                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                      (if (eq? (car temp_1) '<cont-85>)
                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                          (if (eq? (car temp_1) '<cont-86>)
                                                                                                                                                                                                                                                                                                                                                              (let ((k 'undefined))
                                                                                                                                                                                                                                                                                                                                                                (set! k (list-ref temp_1 1))
                                                                                                                                                                                                                                                                                                                                                                (set! value_reg (binding-docstring value_reg))
                                                                                                                                                                                                                                                                                                                                                                (set! k_reg k)
                                                                                                                                                                                                                                                                                                                                                                (set! pc apply-cont))
                                                                                              ...
                                                                                              (if (eq? (car temp_1) '<cont2-23>)
                                                                                                  ...
                                                                                                  (if (eq? (car temp_1) '<cont2-24>)
                                                                                                      (let ((env 'undefined) (handler 'undefined) (k 'undefined))
                                                                                                        ...
                                                                                                        (set! handler (list-ref temp_1 2))
                                                                                                        (set! env (list-ref temp_1 1))
                                                                                                        (set! k_reg (make-cont '<cont-84> value2_reg env handler k))
                                                                                                        (set! handler_reg handler)
                                                                                                        (set! datum_reg value1_reg)
                                                                                                        (set! pc parse))
                                                                                                      (if (eq? (car temp_1) '<cont2-25>)
                                                                                                          (begin
                                                                                                            (set! k_reg (make-cont '<cont-87>))
                                                                                                            (set! handler_reg init-handler)
                                                                                                            (set! datum_reg value1_reg)
                                                                                                            (set! pc parse))
                                                                                                          (error 'apply-cont2
                                                        ...
                                                        (if (eq? (car exp_reg) 'dict-exp)
                                                            ...
                                                            (if (eq? (car exp_reg) 'app-exp)
                                                                (let ((operator 'undefined) (operands 'undefined))
                                                                  ...
                                                                  (set! k_reg
                                                                    (make-cont '<cont-59> operands env_reg handler_reg k_reg))
...
(define*
  ...
  (lambda ()
    (if (null? list1_reg)
        ...
        (begin
          (set! k2_reg
            (make-cont '<cont-76> list1_reg list2_reg proc_reg env_reg
              handler_reg k_reg))
          (set! env2_reg env_reg)
...
(define*
  ...
  (lambda ()
    (if (null? (car lists_reg))
        ...
        (begin
          (set! k2_reg
            (make-cont '<cont-77> lists_reg proc_reg env_reg handler_reg
              k_reg))
          (set! env2_reg env_reg)
  ...
  (lambda ()
    (let ((arg-list 'undefined))
      ...
      (if (null? (car arg-list))
          ...
          (begin
            (set! k2_reg
              (make-cont '<cont-78> arg-list proc_reg env_reg handler_reg
                k_reg))
            (set! env2_reg env_reg)
...
(define*
  ...
  (lambda ()
    (let ((sym 'undefined))
      ...
      (set! k_reg
        (make-cont '<cont-79> args_reg sym handler_reg k_reg))
    ...
    (let ((filename 'undefined))
      ...
      (if (null? (cdr args_reg))
          ...
          (let ((module-name 'undefined))
            ...
            (set! k_reg
              (make-cont '<cont-80> filename env_reg handler_reg k_reg))
        ...
        (if (not (string? filename_reg))
            ...
            (if (not (file-exists? filename_reg))
                ...
                (begin
                  ...
                  (set! k_reg
                    (make-cont '<cont-82> env_reg handler_reg k_reg))
...
(define*
  ...
  (lambda ()
    (if (null? filenames_reg)
        ...
        (begin
          (set! k_reg
            (make-cont '<cont-85> filenames_reg env_reg handler_reg
              k_reg))
...
(define*
  help-prim
  (lambda ()
    (set! k_reg (make-cont '<cont-86> k_reg))
  ...
  (lambda ()
    (if (constant? pattern_reg)
        ...
        (if (pattern-variable? pattern_reg)
            ...
            (begin
              (set! k_reg
                (make-cont '<cont-88> pattern_reg var_reg k_reg))
    ...
    (if (pattern-variable? p1_reg)
        (if (pattern-variable? p2_reg)
            (begin
              ...
              (set! pc apply-cont))
            (begin
              (set! k_reg (make-cont '<cont-89> p1_reg p2_reg k_reg))
...
(define*
  ...
  (lambda ()
    (set! k_reg
      (make-cont '<cont-93> pair1_reg pair2_reg k_reg))
  ...
  (lambda ()
    (if (constant? pattern_reg)
        ...
        (if (pattern-variable? pattern_reg)
            ...
            (if (pair? pattern_reg)
                (begin
                  (set! k_reg (make-cont '<cont-94> pattern_reg s_reg k_reg))
                  (set! pattern_reg (car pattern_reg))
                  (set! pc instantiate))
          ...
          (if (eq? (car temp_1) 'unit)
              ...
              (if (eq? (car temp_1) 'composite)
                  (let ((s1 'undefined) (s2 'undefined))
                    ...
                    (set! k_reg (make-cont '<cont-95> s2 k_reg))
                    (set! s_reg s1)
                    (set! pc apply-sub))
