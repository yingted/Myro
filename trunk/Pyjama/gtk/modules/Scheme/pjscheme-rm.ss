  ...
  (lambda ()
    (if (constant? pattern_reg)
        ...
        (if (pattern-variable? pattern_reg)
            ...
            (begin
              (set! k_reg
                (make-cont '<cont-87> pattern_reg var_reg k_reg))
    ...
    (if (pattern-variable? p1_reg)
        (if (pattern-variable? p2_reg)
            (begin
              ...
              (set! pc apply-cont))
            (begin
              (set! k_reg (make-cont '<cont-88> p1_reg p2_reg k_reg))
...
(define*
  ...
  (lambda ()
    (set! k_reg
      (make-cont '<cont-92> pair1_reg pair2_reg k_reg))
  ...
  (lambda ()
    (if (constant? pattern_reg)
        ...
        (if (pattern-variable? pattern_reg)
            ...
            (if (pair? pattern_reg)
                (begin
                  (set! k_reg (make-cont '<cont-93> pattern_reg s_reg k_reg))
                  (set! pattern_reg (car pattern_reg))
                  (set! pc instantiate))
          ...
          (if (eq? (car temp_1) 'unit)
              ...
              (if (eq? (car temp_1) 'composite)
                  (let ((s1 'undefined) (s2 'undefined))
                    ...
                    (set! k_reg (make-cont '<cont-94> s2 k_reg))
                    (set! s_reg s1)
                    (set! pc apply-sub))
