  ...
  (lambda ()
    (extend (make-empty-environment)
      ...
      (list '()
	    ...
	    (lambda (args k2 env2) (newline) (k2 'ok))
	    (lambda (args k2 env2) (load-file (car args) k2))
	    (lambda (args k2 env2) (k2 (apply null? args)))
	    (lambda (args k2 env2) (k2 (apply cons args)))
	    (lambda (args k2 env2) (k2 (apply car args)))
	    (lambda (args k2 env2) (k2 (apply cdr args)))
	    (lambda (args k2 env2) (k2 args))
	    (lambda (args k2 env2) (k2 (apply + args)))
	    (lambda (args k2 env2) (k2 (apply - args)))
	    (lambda (args k2 env2) (k2 (apply * args)))
	    (lambda (args k2 env2) (k2 (apply / args)))
	    (lambda (args k2 env2) (k2 (apply < args)))
	    (lambda (args k2 env2) (k2 (apply > args)))
	    (lambda (args k2 env2) (k2 (apply = args)))
	    (lambda (args k2 env2) (k2 (apply range args)))
	    (lambda (args k2 env2) (k2 (apply set-car! args)))
	    (lambda (args k2 env2) (k2 (apply set-cdr! args)))
	    (lambda (args k2 env2) (k2 (apply reverse args)))
