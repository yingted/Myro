...
final public class RXTXScribblerPort
{
    // Constants from SerialPort
    ...
    */
     ...
     *  @see gnu.io.SerialPort
     */
    public RXTXScribblerPort( String name ) throws PortInUseException
    {
	if (debug)
	...
	*/
	...
	if (debug)
	    z.reportln( "RXTXPort:RXTXScribblerPort("+name+") returns with fd = " +
			fd);
    }
    ...
    */
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:getOutputStream() called and returning");
	return out;
    }
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:getInputStream() called and returning");
	return in;
    }
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:setSerialPortParams(" +
			b + " " + d + " " + s + " " + p + ") called");
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:getBaudRate() called and returning " + speed);
	return speed;
    }
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:getDataBits() called and returning " + dataBits);
	return dataBits;
    }

    /** Stop bits port parameter */
    private int stopBits=RXTXScribblerPort.STOPBITS_1;
    /** 
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:getStopBits() called and returning " + stopBits);
	return stopBits;
    }

    /** Parity port parameter */
    private int parity= RXTXScribblerPort.PARITY_NONE;
    /** 
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:getParity() called and returning " + parity );
	return parity;
    }


    /** Flow control */
    private int flowmode = RXTXScribblerPort.FLOWCONTROL_NONE;
    /** 
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:setFlowControlMode( " + flowcontrol + " ) called");
	if(monThreadisInterrupted) 
	    {
		if( debug_events )
		    z.reportln(  "RXTXScribblerPort:setFlowControlMode MonThread is Interrupeted returning" );
		return;
	    }
	try {
	...
	if (debug)
	    z.reportln( "RXTXScribblerPort:setFlowControlMode( " + flowcontrol + " ) returning");
    }
    /** 
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:getFlowControlMode() returning " + flowmode );
	return flowmode;
    }
    ...
    */
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:enableReceiveFramming() throwing exception");
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:disableReceiveFramming() called and returning (noop)");
    }
    /** 
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:getReceiveFrammingByte() called and returning " + 0 );
	return 0;
    }
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:disableReceiveTimeout() called");
	timeout = -1;
	NativeEnableReceiveTimeoutThreshold( timeout , threshold, InputBuffer );
	if (debug)
	    z.reportln( "RXTXScribblerPort:disableReceiveTimeout() returning");
    }
    /** 
     *  @param time
     */
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:enableReceiveTimeout() called");
	if( time >= 0 )
	    {
		timeout = time;
	...
	if (debug)
	    z.reportln( "RXTXScribblerPort:enableReceiveTimeout() returning");
    }
    /** 
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:isReceiveTimeoutEnabled() called and returning " + NativeisReceiveTimeoutEnabled() );
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:getReceiveTimeout() called and returning " + NativegetReceiveTimeout() );
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:enableReceiveThreshold( " + thresh + " ) called");
	if(thresh >=0)
	    {
		threshold=thresh;
	...
	if (debug)
	    z.reportln( "RXTXScribblerPort:enableReceiveThreshold( " + thresh + " ) returned");
    }
    /** 
     */
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:disableReceiveThreshold() called and returning");
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:getReceiveThreshold() called and returning " + threshold);
	return threshold;
    }
    /** 
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:isReceiveThresholdEnable() called and returning" + (threshold > 0) );
	return(threshold>0);
    }
    ...
    */
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:setInputBufferSize( " +
			size + ") called");
	if( size < 0 )
	    throw new IllegalArgumentException
		(
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:getInputBufferSize() called and returning " + InputBuffer );
	return(InputBuffer);
    }
    /** 
     *  @param size
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:setOutputBufferSize( " +
			size + ") called");
	if( size < 0 )
	    throw new IllegalArgumentException
		(
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:getOutputBufferSize() called and returning " + OutputBuffer );
	return(OutputBuffer);
    }
    ...
    /** RXTXScribblerPort read methods */
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:checkMonitorThread()");
	if(monThread != null)
	    {
		if ( debug )
		    z.reportln( 
    ...
    {
	if (debug_events)
	    z.report( "RXTXScribblerPort:sendEvent(");
	...
	*/
	...
	if (debug)
	    z.reportln( "RXTXScribblerPort:addEventListener()");
	if( SPEventListener != null )
	    {
	...
	if (debug)
	    z.reportln( "RXTXScribblerPort:Interrupt=false");
    }
    /**
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:removeEventListener() called");
	waitForTheNativeCodeSilly();
	//if( monThread != null && monThread.isAlive() )
	if( monThreadisInterrupted == true )
	    {
		z.reportln( "	RXTXScribblerPort:removeEventListener() already interrupted");
		monThread = null;
	    ...
	    {
		if (debug)
		    z.reportln( "	RXTXScribblerPort:Interrupt=true");
		...
		*/
		if (debug)
		    z.reportln( "	RXTXScribblerPort:calling interruptEventLoop");
		interruptEventLoop( );
			
		if (debug)
		    z.reportln( "	RXTXScribblerPort:calling monThread.join()");
		try {
	...
	monThreadisInterrupted=true;
	z.reportln( "RXTXScribblerPort:removeEventListener() returning");
    }
    /**
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:notifyOnDataAvailable( " +
			enable+" )");
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:notifyOnOutputEmpty( " +
			enable+" )");
	waitForTheNativeCodeSilly();
	MonitorThreadLock = true;
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:notifyOnCTS( " +
			enable+" )");
	waitForTheNativeCodeSilly();
	MonitorThreadLock = true;
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:notifyOnDSR( " +
			enable+" )");
	waitForTheNativeCodeSilly();
	MonitorThreadLock = true;
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:notifyOnRingIndicator( " +
			enable+" )");
	waitForTheNativeCodeSilly();
	MonitorThreadLock = true;
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:notifyOnCarrierDetect( " +
			enable+" )");
	waitForTheNativeCodeSilly();
	MonitorThreadLock = true;
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:notifyOnOverrunError( " +
			enable+" )");
	waitForTheNativeCodeSilly();
	MonitorThreadLock = true;
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:notifyOnParityError( " +
			enable+" )");
	waitForTheNativeCodeSilly();
	MonitorThreadLock = true;
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:notifyOnFramingError( " +
			enable+" )");
	waitForTheNativeCodeSilly();
	MonitorThreadLock = true;
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:notifyOnBreakInterrupt( " +
			enable+" )");
	waitForTheNativeCodeSilly();
	MonitorThreadLock = true;
	...
	synchronized (this) {
	    if (debug)
		z.reportln( "RXTXScribblerPort:close( " + this.name + " )"); 
	...
	if ( fd <= 0 )
	    {
		z.reportln(  "RXTXScribblerPort:close detected bad File Descriptor" );
		return;
	    }
	setDTR(false);
	setDSR(false);
	if (debug)
	    z.reportln( "RXTXScribblerPort:close( " + this.name + " ) setting monThreadisInterrupted"); 
	if ( ! monThreadisInterrupted )
	    {
		removeEventListener();
	    }
	if (debug)
	    z.reportln( "RXTXScribblerPort:close( " + this.name + " ) calling nativeClose"); 
	nativeClose( this.name );
	if (debug)
	    z.reportln( "RXTXScribblerPort:close( " + this.name + " ) calling super.close"); 
	//super.close();
	fd = 0;
	closeLock = false;
	if (debug)
	    z.reportln( "RXTXScribblerPort:close( " + this.name + " ) leaving"); 
    }
    ...
    {
	if (debug)
	    z.reportln( "RXTXScribblerPort:finalize()");
	if( fd > 0 )
	    {
		if (debug)
		    z.reportln( "RXTXScribblerPort:calling close()");
		close();
	    }
	z.finalize();
    }
	...
	{
	    if (debug_write)
		z.reportln( "RXTXScribblerPort:SerialOutputStream:write(int)");
	    if( speed == 0 ) return;
	    if ( monThreadisInterrupted == true )
		{
		    return;
		...
		if (debug_write)
		    z.reportln( "Leaving RXTXScribblerPort:SerialOutputStream:write( int )");
	    } finally {
		synchronized (IOLockedMutex) {
		    IOLocked--;
		}
	...
	public void write( byte b[] ) throws IOException
	{
	    if (debug_write)
		{
		    z.reportln( "Entering RXTXScribblerPort:SerialOutputStream:write(" + b.length + ") "/* + new String(b)*/ );
		}
	    if( speed == 0 ) return;
	    if ( monThreadisInterrupted == true )
		{
		...
		if (debug_write)
		    z.reportln( "Leaving RXTXScribblerPort:SerialOutputStream:write(" +b.length  +")");
	    } finally {
		synchronized(IOLockedMutex) {
		    IOLocked--;
		}
	    ...
	    throws IOException
	{
	    ...
	    if (debug_write)
		{
		    z.reportln( "Entering RXTXScribblerPort:SerialOutputStream:write(" + send.length + " " + off + " " + len + " " +") " /*+  new String(send) */ );
		}
	    if ( fd == 0 ) throw new IOException();
	    if ( monThreadisInterrupted == true )
		{
	    ...
	    try
		{
		    ...
		    if( debug_write )
			z.reportln( "Leaving RXTXScribblerPort:SerialOutputStream:write(" + send.length + " " + off + " " + len + " " +") "  /*+ new String(send)*/ );
		} finally {
		synchronized (IOLockedMutex) {
		    IOLocked--;
		}
	...
	{
	    if (debug)
		z.reportln( "RXTXScribblerPort:SerialOutputStream:flush() enter");
	    if( speed == 0 ) return;
	    if ( fd == 0 ) throw new IOException();
	    if ( monThreadisInterrupted == true )
		{
		    if (debug)
			z.reportln( "RXTXScribblerPort:SerialOutputStream:flush() Leaving Interrupted");
		    return;
		}
	    synchronized(IOLockedMutex) {
		IOLocked++;
	    ...
	    try
		{
		    ...
		    */
		    ...
		    if (debug)
			z.reportln( "RXTXScribblerPort:SerialOutputStream:flush() leave");
		}
	    finally
		{
		    synchronized (IOLockedMutex) {
	...
	{
	    if (debug_read)
		z.reportln( "RXTXScribblerPort:SerialInputStream:read() called");
	    if ( fd == 0 ) throw new IOException();
	    if ( monThreadisInterrupted )
		{
		...
		if (debug_read_results)
		    z.reportln(  "RXTXScribblerPort:SerialInputStream:read() L" );
		waitForTheNativeCodeSilly();
		if (debug_read_results)
		    z.reportln(  "RXTXScribblerPort:SerialInputStream:read() N" );
		int result = readByte();
		if (debug_read_results)
		    //z.reportln(  "RXTXScribblerPort:SerialInputStream:read() returns byte = " + result );
		    z.reportln(  "RXTXScribblerPort:SerialInputStream:read() returns" );
		return( result );
	    }				
	    finally
		{
	...
	public synchronized int read( byte b[] ) throws IOException
	{
	    int result;
	    if (debug_read)
		z.reportln( "RXTXScribblerPort:SerialInputStream:read(" + b.length + ") called");
	    if ( monThreadisInterrupted == true )
		{
		    return(0);
		}
	    ...
	    try
		{
		    ...
		    if (debug_read_results)
			z.reportln(  "RXTXScribblerPort:SerialInputStream:read() returned " + result + " bytes" );
		    return( result );
		}
	    finally
		{
	...
	*/
	...
	{
	    if (debug_read)
		z.reportln( "RXTXScribblerPort:SerialInputStream:read(" + b.length + " " + off + " " + len + ") called" /*+ new String(b) */ );
	    int result;
	    /*
	     * Some sanity checks
	     */
		...
		{
		    if (debug_read)
			z.reportln( "RXTXScribblerPort:SerialInputStream:read() fd == 0");
	    ...
	    if( b==null )
		{
		    ...
		    if (debug_read)
			z.reportln( "RXTXScribblerPort:SerialInputStream:read() b == 0");
	    ...
	    if( (off < 0) || (len < 0) || (off+len > b.length))
		{
		    ...
		    if (debug_read)
			z.reportln( "RXTXScribblerPort:SerialInputStream:read() off < 0 ..");
		    throw new IndexOutOfBoundsException();
		}
		...
		{
		    if (debug_read)
			z.reportln( "RXTXScribblerPort:SerialInputStream:read() Interrupted");
		    return(0);
		}
	    synchronized (IOLockedMutex) {
		IOLocked++;
	    ...
	    try
		{
		    ...
		    if (debug_read_results)
			z.reportln( "RXTXScribblerPort:SerialInputStream:read(" + b.length + " " + off + " " + len + ") returned " + result + " bytes"  /*+ new String(b) */);
		    return( result );
		}
	    finally
		{
	...
	*/
	...
	public synchronized int available() throws IOException
	{
	    ...
	    if ( debug_verbose )
		z.reportln( "RXTXScribblerPort:available() called" );
	    synchronized (IOLockedMutex) {
		IOLocked++;
	    }
	    try
		{
		    ...
		    if ( debug_verbose )
			z.reportln( "RXTXScribblerPort:available() returning " +
				    r );
		    return r;
		}
	    finally
	...
	{
	    if (debug)
		z.reportln( "RXTXScribblerPort:MontitorThread:MonitorThread()"); 
	}
	/**
	...
	{
	    if (debug)
		z.reportln( "RXTXScribblerPort:MontitorThread:run()"); 
	...
	{ 
	    if (debug)
		z.reportln( "RXTXScribblerPort:MonitorThread exiting"); 
	}
    }
    /**
	...
	if ( debug )
	    z.reportln( 
		       "RXTXScribblerPort:staticGetBaudRate( " + port + " )");
	...
	if ( debug )
	    z.reportln( 
		       "RXTXScribblerPort:staticGetDataBits( " + port + " )");
	...
	if ( debug )
	    z.reportln( 
		       "RXTXScribblerPort:staticGetParity( " + port + " )");
	...
	if ( debug )
	    z.reportln( 
		       "RXTXScribblerPort:staticGetStopBits( " + port + " )");
	...
	if ( debug )
	    z.reportln( 
		       "RXTXScribblerPort:staticSetSerialPortParams( " +
		       f + " " + b + " " + d + " " + s + " " + p );
    ...
    {
	if ( debug )
	    z.reportln(  "RXTXScribblerPort:staticSetDSR( " + port +
			 " " + flag );
    ...
    {
	if ( debug )
	    z.reportln(  "RXTXScribblerPort:staticSetDTR( " + port +
			 " " + flag );
    ...
    {
	if ( debug )
	    z.reportln(  "RXTXScribblerPort:staticSetRTS( " + port +
			 " " + flag );
    ...
    {
	if ( debug )
	    z.reportln(  "RXTXScribblerPort:staticIsRTS( " + port + " )" );
    ...
    {
	if ( debug )
	    z.reportln( "RXTXScribblerPort:staticIsCD( " + port + " )" );
    ...
    {
	if ( debug )
	    z.reportln(  "RXTXScribblerPort:staticIsCTS( " + port + " )" );
    ...
    {
	if ( debug )
	    z.reportln(  "RXTXScribblerPort:staticIsDSR( " + port + " )" );
    ...
    {
	if ( debug )
	    z.reportln(  "RXTXScribblerPort:staticIsDTR( " + port + " )" );
    ...
    {
	if ( debug )
	    z.reportln(  "RXTXScribblerPort:staticIsRI( " + port + " )" );
    ...
    {
	if ( debug )
	    z.reportln(  "RXTXScribblerPort:setUARTType()");
    ...
    {
	if ( debug )
	    z.reportln(  "RXTXScribblerPort:setBaudBase()");
    ...
    {
	if ( debug )
	    z.reportln(  "RXTXScribblerPort:getBaudBase()");
    ...
    {
	if ( debug )
	    z.reportln(  "RXTXScribblerPort:setDivisor()");
    ...
    {
	if ( debug )
	    z.reportln(  "RXTXScribblerPort:getDivisor()");
    ...
    {
	if ( debug )
	    z.reportln(  "RXTXScribblerPort:setLowLatency()");
    ...
    {
	if ( debug )
	    z.reportln(  "RXTXScribblerPort:getLowLatency()");
    ...
    {
	if ( debug )
	    z.reportln(  "RXTXScribblerPort:setCallOutHangup()");
    ...
    {
	if ( debug )
	    z.reportln(  "RXTXScribblerPort:getCallOutHangup()");
    ...
    {
	if ( debug )
	    z.reportln(  "RXTXScribblerPort:clearCommInput()");
