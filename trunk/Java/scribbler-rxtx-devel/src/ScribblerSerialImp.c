...
#	include "config.h"
#endif
#include "scribbler_io_RXTXScribblerPort.h"
#endif /* dima */
 ...
 * */
#define RXTXPort(foo) Java_scribbler_io_RXTXScribblerPort_ ## foo
#define RXTXVersion(foo) Java_scribbler_io_RXTXVersion_ ## foo
#define RXTXCommDriver(foo) Java_scribbler_io_RXTXCommDriver_ ## foo
