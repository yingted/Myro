...
namespace IPREFoundationClasses
{
    ...
    public class Defines
    {
        ...
        //private static Dictionary<Myro.Adapters.SensorTypes, String> SensorString = new Dictionary<SensorTypes, string>();
        private static bool SSInitialized = false;

        //public static Dictionary<Myro.Adapters.SensorTypes, String> getSensorString()
        //{
        //    if(!SSInitialized)
        //    {
        //        SensorString.Clear();
